...
public class RectangleWindow extends javax.swing.JPanel {

    private Engine engine;
    private MainWindow mainWindow;

    public RectangleWindow(Engine engine, MainWindow mainWindow) {
        this.engine = engine;
        this.mainWindow = mainWindow;
        JFrame frame = new JFrame("Rectangle");
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        frame.add(this);
        frame.setSize(373, 440);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double width = Double.parseDouble(jTextField3.getText().trim());
        double height = Double.parseDouble(jTextField4.getText().trim());
        ...
        mainWindow.addShapeToComboBox(rectangle);
