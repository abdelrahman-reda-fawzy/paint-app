...
public class SquareWindow extends javax.swing.JPanel {

    private Engine engine;
    private MainWindow mainWindow;

    public SquareWindow(Engine engine, MainWindow mainWindow) {
        this.engine = engine;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double side = Double.parseDouble(jTextField3.getText().trim());
        ...
        mainWindow.addShapeToComboBox(square);
